...
and should return a new array that is identical to the old array. You can name the new array however you'd like. */
 let originalcopy = []
function copy(array,originalcopy){
     originalcopy = [...array]
...
console.log(copy(originalFlavors,originalcopy))
...
for(let i=0; i<array.length; i++){
     ...
     average.push(array[i].split(" "))  
     count+= average[i].length
 
}
return count/average.length
